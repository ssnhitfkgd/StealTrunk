...
- (void) setupMotionManager {
    if (motionMan == nil) {
        ...
        [notif addObserver:self selector:@selector(orientToCurrentRotation) name:@"NT_resetFrame" object:nil];
...
// This method is fired by receiving the notification "NT_resetFrame", and establishes a zero at the last cache
