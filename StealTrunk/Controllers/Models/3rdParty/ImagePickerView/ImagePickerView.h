...
@interface ImagePickerView : NSObject <UIImagePickerControllerDelegate, UIActionSheetDelegate, UINavigationControllerDelegate> {
...
@property (nonatomic, strong) id<ImagePickerDelegate> delegate;
